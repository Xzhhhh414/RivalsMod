...
set_hitbox_value(AT_JAB, 1, HG_ANGLE, 160);
...
set_hitbox_value(AT_JAB, 2, HG_WINDOW_CREATION_FRAME, 7);
...
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 57);
set_hitbox_value(AT_JAB, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_JAB, 2, HG_DAMAGE, 4);
set_hitbox_value(AT_JAB, 2, HG_ANGLE, 160);
