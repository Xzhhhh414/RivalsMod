...
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2);
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_INVINCIBILITY, 0);


set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_LENGTH, 200);
...
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_SFX, asset_get("sfx_ice_chain"));
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_INVINCIBILITY, 1);
//set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_CUSTOM_GRAVITY, .3);
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_VSPEED_TYPE, 1);

set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_LENGTH, 38);
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_ANIM_FRAMES, 26);
...
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_CUSTOM_GRAVITY, .5);

set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_LENGTH, 15);
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_ANIM_FRAMES, 9);
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_ANIM_FRAME_START, 31);
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_CUSTOM_GRAVITY, .5);
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_HITBOX_Y, -31);
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_HIT_SFX, asset_get("sfx_ice_chain"));
