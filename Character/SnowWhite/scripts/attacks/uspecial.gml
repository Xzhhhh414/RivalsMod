...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED,-27);
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.12);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.12);
set_window_value(AT_USPECIAL, 4, AG_WINDOW_CUSTOM_GRAVITY, 1);

set_window_value(AT_USPECIAL, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL, 5, AG_WINDOW_LENGTH, 42);
set_window_value(AT_USPECIAL, 5, AG_WINDOW_ANIM_FRAMES, 21);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.20);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_ANIM_FRAME_START, 33);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.20);
...
set_hitbox_value(AT_USPECIAL, 1, HG_ANGLE, 67);
