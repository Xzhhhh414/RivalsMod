...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ice_chain"));
...
//set_window_value(AT_USPECIAL, 2,AG_WINDOW_HSPEED,15);
//set_window_value(AT_USPECIAL, 2,AG_WINDOW_VSPEED,-13);
set_window_value(AT_USPECIAL, 2,AG_WINDOW_HSPEED,17);
set_window_value(AT_USPECIAL, 2,AG_WINDOW_VSPEED,-12);



set_window_value(AT_USPECIAL, 3,AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USPECIAL, 3,AG_WINDOW_CUSTOM_AIR_FRICTION, 1.4);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, .4);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_TYPE, 7);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_LENGTH, 40);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_ANIM_FRAMES, 12);
