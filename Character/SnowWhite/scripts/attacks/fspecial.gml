...
set_hitbox_value(AT_FSPECIAL, 3, HG_WINDOW_CREATION_FRAME, 24);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_WINDOW_CREATION_FRAME, 40);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_WINDOW_CREATION_FRAME, 54);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_ANGLE, 75);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_HIT_SFX, asset_get("sfx_blow_strong1"));
