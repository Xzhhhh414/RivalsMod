...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("fspecial3"));
set_attack_value(AT_EXTRA_1, AG_NUM_WINDOWS, 2);
set_attack_value(AT_EXTRA_1, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_EXTRA_1, AG_AIR_SPRITE, sprite_get("fspecial3"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("fspecial3_hurt"));
...
set_hitbox_value(AT_EXTRA_1, 1, HG_WINDOW_CREATION_FRAME, 6);
set_hitbox_value(AT_EXTRA_1, 1, HG_LIFETIME, 2);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_X, 86);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_Y, -38);
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 100);
set_hitbox_value(AT_EXTRA_1, 1, HG_HEIGHT, 71);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_EXTRA_HITPAUSE, 5);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HITSTUN_MULTIPLIER, 8);