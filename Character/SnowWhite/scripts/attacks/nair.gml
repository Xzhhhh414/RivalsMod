...
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAMES, 25);
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAME_START, 8);
//set_window_value(AT_NAIR, 2, AG_WINDOW_HAS_WHIFFLAG, 4);
...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_X, 57);
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 67);
...
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, .2);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_blow_medium2"));