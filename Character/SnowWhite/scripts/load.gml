...
//sprite_change_offset("bighurt", 98, 125);
sprite_change_offset("hurtground", 98, 125);
//sprite_change_offset("uphurt", 64, 110);
//sprite_change_offset("downhurt", 64, 110);
//sprite_change_offset("bouncehurt", 98, 125);
sprite_change_offset("spinhurt", 98, 125);

sprite_change_offset("jumpstart", 98, 125);
sprite_change_offset("jump", 98, 125);
sprite_change_offset("doublejump", 98, 125);
sprite_change_offset("walljump", 98, 125);
sprite_change_offset("pratfall", 98, 125);
...
sprite_change_offset("taunt", 98, 125);
